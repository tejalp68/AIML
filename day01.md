...
*Google collab* is a free notebook environment which works on browser(Google server).nothing is installed on laptop
Key points:
...
*Jupyter Notebook* is a free notebook creation environment which works locally on your computer
Key points:
